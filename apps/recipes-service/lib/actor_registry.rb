...
class ActorRegistry
  ROLE_PERMISSIONS = {
    'admin' => %w[dashboard admin recipes:read recipes:write submissions:read publications:read audit:read recipes:approve recipes:reject recipes:archive recipes:export recipes:publish actors:read themes:sync studio:read customers:write],
    'editor' => %w[dashboard admin recipes:read recipes:write submissions:read publications:read recipes:approve recipes:reject recipes:archive recipes:export recipes:publish themes:sync studio:read customers:write],
